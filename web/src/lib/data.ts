...
export const countries: CountryData[] = [
  ...
  { name: "Nigeria", iso3: "NGA", iso2: "NG", region: "West Africa", pillar_scores: { policy_governance: 65, infrastructure_data: 35, talent_education: 50, innovation_ecosystem: 75, deployment_impact: 62 }, composite_score: 57.4, rank: 4, raw_data: { internet_penetration: 39.21, electricity_access: 61.2, fixed_broadband_per100: 0.05, tertiary_enrollment: null, ai_strategy: "Yes", data_protection_law: "Yes", data_centers: 16, oxford_ai_readiness_score: 51.85 } },
  ...
  { name: "Botswana", iso3: "BWA", iso2: "BW", region: "Southern Africa", pillar_scores: { policy_governance: 30, infrastructure_data: 58, talent_education: 32, innovation_ecosystem: 15, deployment_impact: 20 }, composite_score: 31.0, rank: 13, raw_data: { internet_penetration: 81.36, electricity_access: 76.0, fixed_broadband_per100: 3.41, tertiary_enrollment: 21.41, ai_strategy: "No", data_protection_law: "Yes", data_centers: 2, oxford_ai_readiness_score: 37.10 } },
  ...
  { name: "Togo", iso3: "TGO", iso2: "TG", region: "West Africa", pillar_scores: { policy_governance: 32, infrastructure_data: 30, talent_education: 15, innovation_ecosystem: 12, deployment_impact: 15 }, composite_score: 20.8, rank: 25, raw_data: { internet_penetration: 37.02, electricity_access: 59.2, fixed_broadband_per100: 1.23, tertiary_enrollment: null, ai_strategy: "No", data_protection_law: "Yes", data_centers: 1, oxford_ai_readiness_score: null } },
  { name: "Angola", iso3: "AGO", iso2: "AO", region: "Southern Africa", pillar_scores: { policy_governance: 20, infrastructure_data: 32, talent_education: 18, innovation_ecosystem: 12, deployment_impact: 15 }, composite_score: 19.4, rank: 26, raw_data: { internet_penetration: 44.76, electricity_access: 51.1, fixed_broadband_per100: 0.37, tertiary_enrollment: 9.95, ai_strategy: "No", data_protection_law: "Yes", data_centers: 8, oxford_ai_readiness_score: 27.09 } },
  { name: "Zimbabwe", iso3: "ZWE", iso2: "ZW", region: "Southern Africa", pillar_scores: { policy_governance: 18, infrastructure_data: 32, talent_education: 20, innovation_ecosystem: 12, deployment_impact: 12 }, composite_score: 18.8, rank: 27, raw_data: { internet_penetration: 38.43, electricity_access: 62.0, fixed_broadband_per100: 1.57, tertiary_enrollment: 7.75, ai_strategy: "No", data_protection_law: "Yes", data_centers: 1, oxford_ai_readiness_score: null } },
  ...
  { name: "Djibouti", iso3: "DJI", iso2: "DJ", region: "East Africa", pillar_scores: { policy_governance: 15, infrastructure_data: 45, talent_education: 12, innovation_ecosystem: 5, deployment_impact: 8 }, composite_score: 17.0, rank: 31, raw_data: { internet_penetration: 65.02, electricity_access: 65.2, fixed_broadband_per100: 1.47, tertiary_enrollment: null, ai_strategy: "No", data_protection_law: "Yes", data_centers: 2, oxford_ai_readiness_score: null } },
  { name: "Lesotho", iso3: "LSO", iso2: "LS", region: "Southern Africa", pillar_scores: { policy_governance: 22, infrastructure_data: 32, talent_education: 12, innovation_ecosystem: 5, deployment_impact: 5 }, composite_score: 15.2, rank: 32, raw_data: { internet_penetration: 47.99, electricity_access: 57.3, fixed_broadband_per100: 0.38, tertiary_enrollment: null, ai_strategy: "Draft", data_protection_law: "Partial", data_centers: 0, oxford_ai_readiness_score: null } },
  ...
  { name: "Burkina Faso", iso3: "BFA", iso2: "BF", region: "West Africa", pillar_scores: { policy_governance: 22, infrastructure_data: 15, talent_education: 14, innovation_ecosystem: 10, deployment_impact: 10 }, composite_score: 14.2, rank: 35, raw_data: { internet_penetration: 17.02, electricity_access: 21.7, fixed_broadband_per100: 0.07, tertiary_enrollment: 10.04, ai_strategy: "No", data_protection_law: "Yes", data_centers: 0, oxford_ai_readiness_score: 29.45 } },
  ...
  { name: "Sudan", iso3: "SDN", iso2: "SD", region: "East Africa", pillar_scores: { policy_governance: 10, infrastructure_data: 28, talent_education: 15, innovation_ecosystem: 8, deployment_impact: 5 }, composite_score: 13.2, rank: 38, raw_data: { internet_penetration: null, electricity_access: 66.0, fixed_broadband_per100: 0.06, tertiary_enrollment: null, ai_strategy: "No", data_protection_law: "No", data_centers: 0, oxford_ai_readiness_score: null } },
  { name: "Guinea", iso3: "GIN", iso2: "GN", region: "West Africa", pillar_scores: { policy_governance: 15, infrastructure_data: 22, talent_education: 10, innovation_ecosystem: 5, deployment_impact: 8 }, composite_score: 12.0, rank: 40, raw_data: { internet_penetration: 26.50, electricity_access: 51.1, fixed_broadband_per100: 0.01, tertiary_enrollment: null, ai_strategy: "No", data_protection_law: "Yes", data_centers: 0, oxford_ai_readiness_score: null } },
  { name: "Malawi", iso3: "MWI", iso2: "MW", region: "Southern Africa", pillar_scores: { policy_governance: 18, infrastructure_data: 12, talent_education: 10, innovation_ecosystem: 8, deployment_impact: 10 }, composite_score: 11.6, rank: 41, raw_data: { internet_penetration: 17.99, electricity_access: 15.6, fixed_broadband_per100: 0.08, tertiary_enrollment: 2.71, ai_strategy: "No", data_protection_law: "Yes", data_centers: 0, oxford_ai_readiness_score: null } },
  ...
  { name: "Congo (DR)", iso3: "COD", iso2: "CD", region: "Central Africa", pillar_scores: { policy_governance: 10, infrastructure_data: 16, talent_education: 12, innovation_ecosystem: 10, deployment_impact: 8 }, composite_score: 11.2, rank: 42, raw_data: { internet_penetration: 30.55, electricity_access: 22.1, fixed_broadband_per100: 0.02, tertiary_enrollment: 6.38, ai_strategy: "No", data_protection_law: "Partial", data_centers: 1, oxford_ai_readiness_score: null } },
  { name: "Mozambique", iso3: "MOZ", iso2: "MZ", region: "Southern Africa", pillar_scores: { policy_governance: 12, infrastructure_data: 18, talent_education: 10, innovation_ecosystem: 5, deployment_impact: 8 }, composite_score: 10.6, rank: 44, raw_data: { internet_penetration: 19.84, electricity_access: 36.0, fixed_broadband_per100: 0.20, tertiary_enrollment: null, ai_strategy: "No", data_protection_law: "Partial", data_centers: 1, oxford_ai_readiness_score: null } },
  { name: "Sierra Leone", iso3: "SLE", iso2: "SL", region: "West Africa", pillar_scores: { policy_governance: 12, infrastructure_data: 18, talent_education: 10, innovation_ecosystem: 5, deployment_impact: 8 }, composite_score: 10.6, rank: 44, raw_data: { internet_penetration: 20.64, electricity_access: 35.5, fixed_broadband_per100: null, tertiary_enrollment: null, ai_strategy: "No", data_protection_law: "No", data_centers: 0, oxford_ai_readiness_score: null } },
