...
export const countries: CountryData[] = [
  ...
  { name: "Mauritius", iso3: "MUS", iso2: "MU", region: "East Africa", pillar_scores: { policy_governance: 65, infrastructure_data: 78, talent_education: 52, innovation_ecosystem: 35, deployment_impact: 40 }, composite_score: 54.0, rank: 5, raw_data: { internet_penetration: 79.50, electricity_access: 100.0, fixed_broadband_per100: 26.91, tertiary_enrollment: 45.78, ai_strategy: "Yes", data_protection_law: "Yes", data_centers: 10, oxford_ai_readiness_score: 53.27 } },
